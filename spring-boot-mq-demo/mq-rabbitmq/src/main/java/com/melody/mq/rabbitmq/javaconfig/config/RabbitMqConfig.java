package com.melody.mq.rabbitmq.javaconfig.config;

import com.melody.mq.rabbitmq.javaconfig.consumer.LogMessageListener;
...
public class RabbitMqConfig {
    ...
    public SimpleMessageListenerContainer container(
            ...
            @Qualifier(LOG_ALL_QUEUE) Queue queue,
        ...
        container.setMessageListener(logMessageListener);
        return container;
    }
