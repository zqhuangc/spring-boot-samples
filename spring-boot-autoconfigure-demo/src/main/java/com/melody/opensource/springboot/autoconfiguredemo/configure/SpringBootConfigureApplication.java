package com.melody.opensource.springboot.autoconfiguredemo.configure;
...
public class SpringBootConfigureApplication implements EnvironmentAware {

    public static void main(String[] args) {
        SpringApplication application =
                new SpringApplication(SpringBootConfigureApplication.class);
